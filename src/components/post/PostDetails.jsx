        ...
        <>
          <div className="flex items-center justify-between">
            ...
            {appear &&
              ...
              { userData.uid === document.createdBy.id ? <button aria-label="delete the article" onClick={handleDelete}>Delete</button> :
              <button aria-label="you can't delete the article" className="text-green-500 ">You Can't Delete this</button>}
              </div>
            }
          </div>
