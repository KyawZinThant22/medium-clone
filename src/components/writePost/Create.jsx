...
const Create = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-20 flex gap-12 mb-20">
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-5 w-[50rem] mb-32">
            <label
              htmlFor="title"
              className="text-xl font-bold tracking-wider "
            >
        ...
        <div className="flex flex-col gap-12">
          ...
          {imageError && (
            <p className="bg-red-200 p-2 rounded-lg text-center text-xl">Failed Uploading Image</p>
          )}
        </div>
      </div>
    </>
